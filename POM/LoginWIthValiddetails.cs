...
namespace ComprehensiveSpecflow.POM
{
    public class LoginWIthValiddetails
    {
        ...
        {
            Thread.Sleep(2000);
            BaseClass.driver.FindElement(By.XPath("//input[@id='login-email']")).SendKeys("abhi@gmail.com");
            BaseClass.driver.FindElement(By.XPath("//input[@id='login-password']")).SendKeys("Abhi@1234");   
        }
        public void ClickOnLoginButton()
        {
            BaseClass.driver.FindElement(By.XPath("//input[@type='submit']")).Click();
            ((ITakesScreenshot)BaseClass.driver).GetScreenshot().SaveAsFile(@"C:\Users\mindc1may270\Desktop\Comprehensive Assessment\Specflow\ComprehensiveSpecflow\Reports\Login1.png");
        }
    }
}
